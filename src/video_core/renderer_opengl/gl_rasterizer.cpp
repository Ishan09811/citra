...
RasterizerOpenGL::RasterizerOpenGL(Memory::MemorySystem& memory,
    ...
    : VideoCore::RasterizerAccelerated{memory}, driver{driver_},
      ...
      texture_buffer{driver, GL_TEXTURE_BUFFER, IsVendorMali() ? 11264 : texture_buffer_size},
      texture_lf_buffer{driver, GL_TEXTURE_BUFFER, IsVendorMali() ? 525312 : texture_buffer_size} {
